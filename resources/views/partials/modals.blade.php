...
<div class="modal fade" id="viewVehicle" tabindex="-1" aria-labelledby="viewVehicleLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen bg-dark text-light">
        <div class="modal-content bg-dark text-light">
            ...
            <div class="modal-body">
                <table class="table table-striped projects table-light" id="vehiclePicker">
                    <thead>
                        <tr>
...
<div class="modal fade" id="chooseClients" tabindex="-1" aria-labelledby="chooseClientsLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen bg-dark text-light">
        <div class="modal-content bg-dark text-light">
            ...
            <div class="modal-body">
                <table class="table table-striped projects table-light" id="clientPicker">
                    <thead>
                        <tr>
                            <th style="width: 10%" class="text-center">
                                Client ID
