...
@section('container')
    ...
    <div class="row bg-dark text-light" style="--bs-gutter-x: 0rem; height:100vh">
        <div class="col-4 bg-dark text-light">
            <div class="container">
                <p class="fs-4 text-center">Vehicle Receiver</p>
        ...
        <div class="col bg-dark text-light">
            <div class="container p-3">
                <p class="fs-4 text-center text-light">Vehicle Entered Data</p>

                <table class="table table-striped projects table-light" id="vehicleTableList">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($vehicleData as $v)
                            <tr>
                                ...
                                {{-- The button can't be click coz it's uncomplited --}}
                                <td class="project-actions text-right">
                                    <button class="btn btn-secondary hoverbtn btn-sm">
