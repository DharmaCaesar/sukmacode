...
@section('container')
    ...
    <div class="row bg-dark text-light" style="--bs-gutter-x: 0rem; height:100vh">
        <div class="col-md-4 bg-dark text-light">
            <div class="container d-flex justify-content-center flex-column" style="width: 80%" id="choiceBetweenCashCredit"> 
            ...
            <div class="container" id="transactionByCredit" style="display: none;">
            ...
            <div class="container" id="transactionByCash" style="display: none;">
        ...
        <div class="col-md-8 bg-dark text-light">
            <div class="container p-3 mb-3 mt-3 border border-dark">
                <p class="fs-4 text-center">Customer Entered Data</p>
                ...
                <table class="table table-striped projects table-light" id="customerTable">
                    <thead>
                        <tr>
            ...
            <div class="container p-3 mb-3 border border-dark" id="cashTable">
                ...
                <table class="table table-striped projects table-light" id="transactionCashTable">
                    <thead>
                        <tr>
                            <th style="width: 10%" class="text-center">
                                Cash Code
            ...
            <div class="container p-3 mb-3 border border-dark" id="creditTable">
                <p class="fs-4 text-center">Transaction by Credit</p>

                <table class="table table-striped projects table-light" id="transactionCreditTable">
                    <thead>
                        <tr>
                            <th style="width: 10%" class="text-center">
                                Credit Code
            ...
            <div class="container p-3 mb-3 border border-dark" id="instalmentTable">
                ...
                <table class="table table-striped projects table-light" id="unpaidInstalmentTable">
                    <thead>
                        <tr>
                            <th style="width: 15%" class="text-center">
                                Credit Code
