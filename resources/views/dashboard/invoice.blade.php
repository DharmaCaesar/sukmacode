    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="body border border-dark border-2 p-5">
                    ...
                    <div class="summary">
                        ...
                        <i> Vehicle </i>
                        <div class="vehicle-list d-flex justify-content-between">
            ...
            <div class="text-center">
                Copyright (C) Origin Engine 9999BC until Apocalypse<br>We well deliver ur product even if to SUPERNOVA
            </div>
        </div>
